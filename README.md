...
γ越大，无人车会越重视以前的经验，越小就更重视眼前利益。α取值范围为0~1，取值越大，保留之前训练的效果就越少。可以看出当α取值为1时，新Q值将完全取代旧Q值，每次训练得到新值就会完全忘记之前的训练结果，α取值为0时，无论如何训练AI也无法学习到新Q值。这些参数值都是人为设定的，需要根据经验慢慢调整。
